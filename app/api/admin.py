...
@router.get("/project-allocations/{project_id}/suggested-employees/", response_model=List[UUID])
def get_suggested_employees(project_id: UUID, db: Session = Depends(get_db)):
